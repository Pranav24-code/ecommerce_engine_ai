        ...
        <form onSubmit={handleSearch} className="flex-1 max-w-lg relative">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-10 pr-12 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200/0 dark:border-slate-700/60 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:bg-white dark:focus:bg-slate-800 transition-all duration-200"
            />
            <button
              type="submit"
              title="AI Semantic Search"
              className="absolute right-2 p-1.5 rounded-lg bg-gradient-to-r from-primary-600 to-primary-500 text-white hover:shadow-glow-sm transition-all duration-200 hover:scale-105"
            >
